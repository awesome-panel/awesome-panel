...
from awesome_panel.assets.csv import KICKSTARTER_DASHBOARD_PATH
...
config.extension(url="kickstarter_dashboard")
dashboard = KickstarterDashboard()

dashboard.settings.servable(area="sidebar")
dashboard.main.servable()
