...
APPLICATION = site.create_application(
    url="highcharts-network",
    name="HighCharts Network",
    author="Marc Skov Madsen",
    description="Interactive Network Graph. Showcase of the panel-highcharts package.",
    description_long=__doc__,
    thumbnail="highcharts-network.png",
    tags=["HighCharts", "graph"],
    resources={
        "code": "highcharts_network/highcharts_network.py",
...
def view():
    ...
    return pn.template.FastListTemplate(
        site="Awesome Panel", title="HighCharts Network", main=[INTRO_SECTION, component]
    )
