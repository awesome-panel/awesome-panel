...
def view() -> FastListTemplate:
    ...
    template = FastListTemplate(site="Awesome Panel", title="Volume Profile Analysis")
    ...
    template.main[:] = [
        ...
        load_data_section.view,
        candle_stick_and_volume_section.view,
        signal_analysis_section.view,
    ]
    return template
