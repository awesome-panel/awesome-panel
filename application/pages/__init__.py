...
from application.pages.awesome_panel_express_tests import (
    ...
    test_divider, test_echarts, test_fontawesome, test_headings, test_markdown,
    test_material, test_model_viewer, test_perspective, test_progress_ext,
    test_share_links, test_spinners, test_wired)
