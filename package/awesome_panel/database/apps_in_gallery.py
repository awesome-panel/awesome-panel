...
from awesome_panel.database.settings import GITHUB_RAW_URL
...
APPS_IN_GALLERY = [
    Resource(
        ...
        url=GITHUB_RAW_GALLERY_URL + "bootstrap_dashboard/main.py",
    ...
    Resource(
        name="Test Spinners",
        url=GITHUB_RAW_GALLERY_URL + "awesome_panel_express_tests/test_spinners.py",
