...
class Application(param.Parameterized):
    ...
    title = param.String(allow_None=False, doc="The Title to show to the user. For example 'AWESOME-PANEL'")
    url = param.String(allow_None=False, doc="The full url to the application. For example 'https://awesome-panel.org")
