...
DEFAULT_URL = "https://github.com/MarcSkovMadsen/awesome-panel/blob/master/package/awesome_panel/express/assets/images/spinner.gif?raw=true"
FACEBOOK_URL = "https://github.com/MarcSkovMadsen/awesome-panel/blob/master/package/awesome_panel/express/assets/images/spinner_facebook.gif?raw=true"
...
class SpinnerBase(pn.pane.HTML):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super().__init__(text, width=self.width, height=self.height, *args, **kwargs)
