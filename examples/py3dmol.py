...
def _create_app(theme=THEME):
    ...
    pn.Column("## Basic Example", basic_viewer).servable()
    ...
    pn.Column("## Grid Example", grid_viewer).servable()
    ...
    * (null), Energy   -1000.0000000
    ...
    interactive_viewer = Py3DMol(
        interactive_view, height=400, sizing_mode="stretch_width", name="Interactive"
    )
    pn.Column("## Interactive Example", interactive_viewer).servable()

    examples = [
        (basic_view, basic_viewer),
        (grid_view, grid_viewer),
        (interactive_view, interactive_viewer),
    ]
    ...
    background = pn.widgets.ColorPicker(value=background_color, name="Background").servable(
        area="sidebar"
    )
    ...
    style = pn.widgets.RadioButtonGroup(
        value="sphere",
        options=["line", "cross", "stick", "sphere"],
        name="Style",
        button_type="success",
