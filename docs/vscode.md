...
You can use the [multi-command extension](https://marketplace.visualstudio.com/items?itemName=ryuta46.multi-command) to configure a keyboard short cut to execute `panel serve <relativeFile.py>`
...
Please note that [andaag](https://github.com/andaag) reported the below to not work on ubuntu 18.04.3 LTS with Python 3.6.8. He gets a `ValueError: signal only works in main thread` error. See [issue 648](https://github.com/panel/panel/issues/648). It's working really well for me on Windows with Python 3.7.4 though.
...
![Python: Remote Attach](https://awesome-panel.readthedocs.io/en/latest/_images/vscode_python_remote_attach.png)

for more info see the [VS Code section at awesome-panel.readthedocs.io]
(https://awesome-panel.readthedocs.io/en/latest/vscode.html#integrated-debugging)
"""
)
...
Panel if you `import panel as st`. Then you can write dataframes and charts to the browser window
...
![Import Panel](_static/images/vscode_debugging_console3.png)
...
## Installing the Panel Repo for Development using Visual Studio Online

I would like to experiment with and maybe contribute to the [panel/panel](https://github.com/panel/panel) repo.

There is an official Panel [Contributing guide](https://github.com/panel/panel/wiki/Contributing) I can follow to get up and running.
...
### Forking the Panel Repo

Forking a repository is a simple two-step process.

1 On GitHub navigate to the [panel/panel](https://github.com/panel/panel) repository
2 In the top-right corner of the page, click Fork

![Fork Button](https://help.github.com/assets/images/help/repository/fork_button.jpg)

That's it! Now I have a fork of the original panel/panel repository.

![Fork of Panel](_static/images/panel_fork.png)

### Setting up the Panel Repo as a a Visual Studio Online Environment
...
To create a docker container environment containing the panel repo I followed step 1-4 of the offical [VS Code Quickstart Guide](https://docs.microsoft.com/en-us/visualstudio/online/quickstarts/vscode). But I replaced the `microsoft/vsonline-quickstart` with `<my-user-name>/panel`.

![Replicate with panel/panel](_static/images/vscode_vso_quickstarts_panelpanel.png)
...
I then followed the [Ubuntu](https://github.com/panel/panel/wiki/Contributing#ubuntu) section with
...
In order to open Panel in your browser you need to forward the ports 3000 and 8501.
...
![Panel hello](_static/images/vscode_vso_panel_hello.png)
...
I could not exactly follow the [Contributing guide](https://github.com/panel/panel/wiki/Contributing). I've filed the issues I saw as [panel/panel issue #665](https://github.com/panel/panel/issues/665).
