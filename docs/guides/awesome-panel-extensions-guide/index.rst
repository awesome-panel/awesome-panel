...
- An upcoming, important sub category of Inheritance Extensions are called **Web Component Extensions**. The `WebComponent` pane is essentially a `HTML` pane that supports bidirectional communication. It will provide you with the super powers of the Bokeh Extensions below for 80% of your use cases. But they require a minimum of javascript skills and are faster to develop.
